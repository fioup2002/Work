...
((obj = new Object()).title = "課程如何購買?"),
  (obj.answer =
    "1. 在首頁上選擇想購買的課程與想要的觀看時間長度，並加入購物車<br>2. 結帳並付款<br>3. 等待管理員確認付款<br>4. 請享受您購買的課程"),
  ...
  (obj.answer =
    "下面是一個示範影片，如果您可以順利觀看的話，<br>代表您可以觀看本站上所有的課程影片"),
  normal_questions.push(obj),
  ((obj = new Object()).title = "網站登入需要注意哪些事項?"),
  (obj.answer =
    "為了保障使用者帳號安全，本站在登入時全面使用兩階段驗證。<br>在輸入完帳號密碼後，請到您當初註冊時填寫的信箱收取驗證碼並填入才能登入"),
  normal_questions.push(obj),
  ((obj = new Object()).title = "為什麼有時候會出現「登入逾期」的提示?"),
  (obj.answer =
    "因為安全性考量，每次從登入開始後，只能使用40分鐘，<br>時間一到就會切斷請使用者重新登入。<br>但是如果您正在收看課程影片，沒有進行其他操作的話，則不受影響"),
  normal_questions.push(obj),
